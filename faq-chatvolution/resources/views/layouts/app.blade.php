...
<head>
    ...
    <title>FAQ Dynamic Chat</title>
    <!-- Add Bootstrap CSS from CDN -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">
    <link href="{{ asset('css/variable.css') }}" rel="stylesheet">
    <link href="{{ asset('css/component/content.css') }}" rel="stylesheet">
    <link href="{{ asset('css/component/sidebar.css') }}" rel="stylesheet">
...
<body>
    ...
    <aside class="sidebar offcanvas-lg offcanvas-start">
        ...
        <div class="logo-brand mt-lg-5">
            <div>
                <h6 class="title-store">FAQ Manager</h6>
                <p class="tagline-store">by Genio Chatvolution</p>
            </div>
        </div>
        <hr />
        <nav class="menu flex-fill">
            <div class="section-menu">
                <a href="{{ route('home') }}" class="item-menu @isActiveRoute('home')">
                    <p><i style="font-size: 18px;" class="fas fa-th-large me-3 ms-1"></i> Dashboard</p>
                </a>
            </div>
            <div class="section-menu">
                <p class="fs-18 fw-500 mb-2">List FAQ</p>
            
                <a href="{{ route('questions.index') }}" class="item-menu @isActiveRoute('questions.index')" onclick="handleClickMenu(this)">
                    <p class="flex-fill"><i style="font-size: 18px;" class="ms-1 me-3 fa-regular fa-circle-question"></i> FAQ</p>
                </a>
            
                <a href="{{ route('product_hostings.index') }}" class="item-menu @isActiveRoute('product_hostings.index')" onclick="handleClickMenu(this)">
                    <p> <i style="font-size: 18px;" class="ms-1 me-3 fa-solid fa-globe"></i> Produk Hosting</p>
                </a>
            
                <a href="{{ route('payments.index') }}" class="item-menu @isActiveRoute('payments.index')" onclick="handleClickMenu(this)">
                    <p> <i style="font-size: 18px;" class="ms-1 me-3 fa-regular fa-credit-card"></i>Metode Pembayaran</p>
                </a>
            </div>
            <div class="section-menu">
                <p class="fs-18 fw-500 mb-2">Settings</p>

                <a href="{{ route('account-settings.index') }}" class="item-menu @isActiveRoute('account-settings.index')" onclick="handleClickMenu(this)">
                    <p> <i style="font-size: 18px;" class="ms-1 me-3 fas fa-cog"></i> Account Settings</p>
                </a>
                
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="item-menu" style="background-color: transparent;border:0px solid transparent" type="submit"><i style="font-size: 18px;" class="ms-1 fas fa-power-off"></i>Logout</button>
                </form>
            </div>
        </nav>
        <footer>
            <div class="d-flex gap-3 align-items-center mb-4">
                ...
                <div>
                    ...
                    <label for="checkbox" class="label-toggle">
                        <img src="{{ asset('icons/ic_moon.svg') }}" width="50%" class="ic-theme" id="ic-dark"
                            alt="Icon Dark" />
                        <img src="{{ asset('icons/ic_sun.svg') }}" width="50%" class="ic-theme" id="ic-light"
                            alt="Icon Light" />
                    </label>
                </div>
            </div>
            <p>©2023 PT. Genio Infinity. All rights reserved.</p>
        </footer>
    </aside>
    <main class="content flex-fill">
        <section>
            ...
            <div class="d-flex gap-3 align-items-center">
                <div>
                    <p class="title-content mb-2">Hello Admin,</p>
        ...
        <!-- section untuk task -->
      <section class="d-flex flex-row gap-4 justify-content-between">
        @yield('content')
      </section>
    </main>
