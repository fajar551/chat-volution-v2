...
<a name="list-resource"></a>
## List Resource

|       Project     |       Env      |      Git URL     |       Deploy URL      |       Site URL        |
|       :-          |       :-       |      :-          |       :-              |       :-              |
|   Dashboard Agent v1    |     Staging      |      http://gitserver2.qwords.net/gina/livechat                              |   -   |   stagingv1.chatvolution.com      |
|   Client area v1        |     Staging      |      http://gitserver2.qwords.net/gina/livechat/-/tree/master/test_client    |   -   |   -                               |
|   Socket v1             |     Staging      |      http://gitserver2.qwords.net/aep/socket-qchat                           |   -   |   -                               |
|   Dashboard Agent v2    |     Staging      |      http://gitserver2.qwords.net/Faiz/chatvolution                          |   -   |   stagingv2.chatvolution.com      |
|   Client area v2        |     Staging      |      http://gitserver2.qwords.net/Faiz/client-chatvolution                   |   -   |   clientarea.chatvolution.com     |
|   Socket v2             |     Staging      |      http://gitserver2.qwords.net/aep/chatvolutionV2                         |   -   |   stagingbev2.chatvolution.com    |
