<div class="modal fade" id="editOpportunity" tabindex="-1" role="dialog" aria-labelledby="editOpportunity" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editOpportunity">
                    <i class="fas fa-handshake"></i> Edit Opportunity
                </h5>
