                                    ...
                                    <tr>
                                        <td class="text"
                                            ...
                                            <div class="mktEditable" id="main_text">
                                                <p style="margin-bottom: 10px;">{!! __('email.body.greetings', ['name' => $data['name']]) !!}</p>
                                                <p>
                                                    {{ __('email.reset_password.body.content') }}
                                                </p>
                                                <div class="mktEditable" id="download_button" style="text-align: center;">
                                                    <a class="btn-qchat-confirm"  href="{{ $data['url'] }}">{{ __('email.reset_password.body.button_reset') }}</a><br>
                                                </div>
                                                <br>
                                            </div>
                                        </td>
