...
<html>
    ...
    <head>
        ...
        <title>{{ __('email.body.verify_change_email_request.page_title') }}</title>
        <style>
            .btn-qchat-confirm {
                                    ...
                                    <tr>
                                        <td class="head-title"
                                            ...
                                            <div class="mktEditable" id="main_title">
                                                {{ __('email.body.verify_change_email_request.page_title') }}
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="text"
                                            ...
                                            <div class="mktEditable" id="main_text">
                                                <p style="margin-bottom: 10px;">{!! __('email.body.verify_change_email_request.greetings', ['name' => $details['name']]) !!}</p>
                                                <p>
                                                    {{ __('email.body.verify_change_email_request.content') }}
                                    ...
                                    <tr>
                                        <td class="text"
                                            ...
                                            <div class="mktEditable" id="download_button" style="text-align: center;">
                                                <p style="text-align: center;">{{ __('email.body.verify_change_email_request.or') }}</p>
                                                <a class="btn-qchat-confirm"  href="{{ route('user.verify', $details['token']) }}">{{ __('email.body.verify_change_email_request.button_confirm') }}</a><br>
                                                <br>
                                                <br>
                                            </div>
                                        </td>
