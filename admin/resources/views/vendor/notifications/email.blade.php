...
<html>
    ...
    <head>
        ...
        <title>{{ __('email.reset_password.body.page_title') }}</title>
        <style>
            .btn-qchat-confirm {
                                ...
                                <table
                                    ...
                                    <tr>
                                        <td class="head-title"
                                            ...
                                            <div class="mktEditable" id="main_title">
                                                {{ __('email.reset_password.body.page_title') }}
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td class="text"
                                            ...
                                            <div class="mktEditable" id="main_text">
                                                <p style="margin-bottom: 10px;">{!! __('email.reset_password.body.greetings') !!}</p>
                                                <p>
                                                    {{ __('email.reset_password.body.content') }}
                                                </p>
                                                <div class="mktEditable" id="download_button" style="text-align: center;">
                                                    <a class="btn-qchat-confirm"  href="{{ $actionUrl }}">{{ __('email.reset_password.body.button_reset') }}</a><br>
                                                </div>
                                                <br>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="text"
                                            style="border-collapse: collapse;border: 0;margin: 0;padding: 0;-webkit-text-size-adjust: none;color: #555559;font-family: Arial, sans-serif;font-size: 16px;line-height: 24px;">
                                            <p>
                                                {{ __('email.reset_password.body.or') }}
                                                <a href="{{ $actionUrl }}">{{ $actionUrl }}</a>
                                            </p>
                                            <br>
                                            <p>
                                                {!! __('email.reset_password.body.content_closing') !!}
                                                <br>
                                                <br>
                                                {{ __('email.reset_password.body.regards') }},
                                                <br>
                                                {{ config('app.name') }}
                                            </p>
