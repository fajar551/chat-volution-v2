            ...
            <div class="col-12 col-md-12 col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <h2 class="card-title text-center font-size-24 font-weight-bold text-tangerin">Form Reset Password
                        </h2>
                        ...
                        <form class="form-horizontal" id="btn-save" data-parsley-validate
                            ...
                            <div class="form-group mt-1">
                                ...
                                <span class="text-danger" id="err_confirm_password">Confirmation password not
                                    same!</span>
                            </div>
