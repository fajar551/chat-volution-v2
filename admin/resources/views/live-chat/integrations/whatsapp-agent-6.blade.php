        ...
        <div class="row">
            <div class="col-12 mb-3">
                <div class="page-title-box d-flex align-items-center justify-content-between" style="padding-bottom: 5px;">
                    <h4 class="mb-0">Integration Whatsapp For BW</h4>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.showFormConnect = function() {
                ...
                fetch('https://waserverlive.genio.id/wa6/init', {
                        method: 'GET',
                        headers: {
            ...
            window.disconectWa = function() {
                ...
                fetch('https://waserverlive.genio.id/wa6/logout', {
                        method: 'GET',
                        headers: {
                            'Content-Type': 'application/json',
                        }
            ...
            function startFallbackPolling() {
                fallbackInterval = setInterval(() => {
                    fetch('https://waserverlive.genio.id/wa6/status', {
                            method: 'GET',
                            headers: {
                                'Content-Type': 'application/json',
                            }
            ...
            function checkQRCodeFallback() {
                ...
                fetch('https://waserverlive.genio.id/wa6/qr', {
                        method: 'GET',
                        headers: {
                            'Content-Type': 'application/json',
                        }
