...
<body data-sidebar="dark" ng-app="Qchat">
        ...
        @empty($guest)
            ...
            <div class="vertical-menu">
                ...
                <div data-simplebar class="h-100">
                    ...
                    <!--- Sidemenu -->
                    <div id="sidebar-menu" ng-controller="appCRM">
                        <!-- Left Menu Start -->
                        <ul class="metismenu list-unstyled" id="side-menu">
                            <li class="menu-title" id="labelSideMenu"></li>
                            <li ng-repeat="value in crm_menu" ng-init="crm_menu != null" metis="">
                                ...
                                <ul ng-if="value.haveChildren" class="sub-menu" aria-expanded="false">
                                    <li ng-repeat="valChild in value.children">
                                        <a href="<%= valChild.link %>">
                                            <i class="<%= valChild.icon %>"></i>
                                            <span ng-bind="valChild.menu"></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
    ...
    @empty($guest)
        ...
        <script src="/js/app/app-crm.js"></script>
    @endempty
