...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Add primary card | Qchat | Qwords Chatting Platform</title>
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"><i class="ri-arrow-left-line mr-2"></i> Back to select how to pay</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-center mb-5">
                                    <h3 class="mb-4">Add Primary Card</h3>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                                    ...
                                    <div class="card-body p-4">
                                        <div class="text-left">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Insert name on card">
                                            </div>
                                            <div class="form-group">
                                                <label>Card Number</label>
                                                <input type="text" name="name" class="form-control" placeholder="xxxxxxxxxxxxxxxx">
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    <label>Expiry</label>
                                                    <input type="text" name="name" class="form-control" placeholder="mm/yyyy">
                                                </div>
                                                <div class="col-md-6">
                                                    <label>CVV/CVC <i class="ri-information-line"></i></label>
                                                    <input type="text" name="name" class="form-control" placeholder="3 digits">
                                                </div>
                                            </div>
                                            <div class="mt-2 mb-3">
                                                <a href="payment-method.html" class="btn btn-primary btn-block w-md">Review Tier & Payment Method</a>
                                            </div>
                                        </div>
