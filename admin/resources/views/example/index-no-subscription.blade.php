                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-center">
                                    <h5><span class="ri-error-warning-line"></span> You Have No Active Subscription</h5>
                                    <p>You will need to subscribe to one of OneTalk's tier in order to keep using this services</p>
                                    <div class="form-group">
                                        <a href="subscription.html" class="btn btn-primary waves-effect waves-light">Start subscription</a>
                                    </div>
                                </div>
                            </div>
                        </div>
