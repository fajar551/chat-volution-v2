...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>LINE | Integration | Qchat | Qwords Chatting Platform</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="p-2" src="assets/images/illustration/ic_line.svg">
                                        <p>Coming soon in Q3 2021</p>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row -->
