...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Add new contact | Qchat | Qwords Chatting Platform</title>
                                ...
                                <div class="card pricing-box">
                                    <div class="card-body p-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="origin" class="form-control" placeholder="Type full name here">
                                        </div>
                                        <div class="form-group">
                                            <label>Alias <span class="font-weight-normal">(optional)</span></label>
                                            <input type="text" name="origin" class="form-control" placeholder="Type alias name here">
                                        </div>
                                        <div class="form-group">
                                            <label>Email <span class="font-weight-normal">(optional)</span></label>
                                            <input type="text" name="origin" class="form-control" placeholder="Type email address here">
                                        </div>
                                        <div class="form-group">
                                            <label>Phone Number <span class="font-weight-normal">(optional)</span></label>
                                            <input type="text" name="origin" class="form-control" placeholder="+628XXXXXXXXX">
                                            <span class="text-muted"><span class="ri-information-line"></span> Always start the phone number with the country code without the “+” sign e.g. “628XXXXXXXXX”.</span>
                                        </div>
                                        <a href="detail-contact.html" class="btn btn-primary waves-effect waves-light">Save changes</a>
                                    </div>
                                </div>
                            </div>
                        </div>
