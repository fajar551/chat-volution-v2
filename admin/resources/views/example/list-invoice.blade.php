...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>List invoice | Integration | Qchat | Qwords Chatting Platform</title>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="general-quick-replies.html">General Quick Replies</a></li>
                                    <li><a href="personal-quick-replies.html">Personal Quick Replies</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="case-labels.html">Case Labels</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>TTT/NT/PF-INV/2021/VII/071</td>
                                                    <td>27 Jul 2021</td>
                                                    <td>28 Jul 2021</td>
                                                    <td>Rp 500.000</td>
                                                    <td><span class="badge badge-danger">Unpaid</span></td>
                                                    <td>
                                                        <a href="detail-invoice.html" data-toggle="modal" class="text-info"><i class="ri-information-line font-size-18" style="position: relative;top: 4px;"></i> Detail</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
