...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Select how to pay | Qchat | Qwords Chatting Platform</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Start Subscription</h4>
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);"><i class="ri-arrow-left-line mr-2"></i> Back to select tier</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-center mb-5">
                                    <h3 class="mb-4">Select How You Pay</h3>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                                ...
                                <div class="card pricing-box">
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            ...
                                            <h5 class="font-weight-bold mt-4">Automatic Payments</h5>
                                            <p class="text-muted">Automatically charge the selected primary payment method.</p>
                                            <div class="mt-2 mb-3">
                                                <a href="payment-method-credit-card.html" class="btn btn-primary w-md">Select method</a>
                                            </div>
                                        </div>
                                ...
                                <div class="card pricing-box">
                                    <div class="card-body p-4">
                                        <div class="text-center">
                                            ...
                                            <h5 class="font-weight-bold mt-4">Manual Payments</h5>
                                            <p class="text-muted">Make payments manually via bank transfers.</p>
                                            <div class="mt-2 mb-3">
                                                <div class="alert alert-info fade show mb-3" role="alert">
                                                    <i class="mdi mdi-alert-circle-outline mr-2"></i>
                                                    No credit card required
                                                </div>
                                                <a href="payment-method-review-tier.html" class="btn btn-primary w-md">Select method</a>
                                            </div>
                                        </div>
