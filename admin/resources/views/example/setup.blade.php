...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Setup | Organization | Qwords Chatting Platform</title>
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#home1" role="tab" aria-selected="true">
                                                    ...
                                                    <span class="d-none d-sm-block">Office Hours</span> 
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#messages1" role="tab" aria-selected="false">
                                                    ...
                                                    <span class="d-none d-sm-block">Away Message</span>   
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#settings1" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-cog"></i></span>
                                                    <span class="d-none d-sm-block">Closing Message</span>    
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#settings2" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-cog"></i></span>
                                                    <span class="d-none d-sm-block">User Rating</span>    
                                                </a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="mb-4">
                                                            <div class="float-right">
                                                                <button type="button" class="btn btn-sm btn-success waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#invite-member">
                                                                    <i class="ri-add-line align-middle mr-2"></i> Add office hour
                                                                </button>
                                                            </div>
                                                            <h5>Office Hours</h5>
                                                        </div>
                                                        <hr>
                                                        <p>The office hours added will be the total hours your organization is available for. E.g if you were to add ‘Weekdays 09:00 - 17:00’ and ‘Monday 09:00 - 18:00’ then ‘Monday’ will effectively be open from 09:00 - 18:00.</p>
                                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>17:00</td>
                                                                    <td>
                                                                        <a href="#detail-member" data-toggle="modal" class="text-warning"><i class="ri-edit-box-line font-size-18" style="position: relative;top: 4px;"></i> Edit</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
