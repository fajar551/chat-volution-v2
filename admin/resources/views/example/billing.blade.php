...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Change password | Security | Qwords Chatting Platform</title>
                            ...
                            <div class="col-xl-6 col-sm-12">
                                <div class="card pricing-box">
                                    <div class="card-header justify-content-between">
                                        <h5><span class="ri-user-setting"></span> Change password</h5>
                                    </div>
                                    <div class="card-body p-4">
                                        <p>Follow the instructions below.</p>
                                        <div class="form-group">
                                            <label>New Password</label>
                                            <input type="password" name="password" class="form-control" placeholder="Input your new password">
                                        </div>
                                    </div>
                                </div>
                            </div>
