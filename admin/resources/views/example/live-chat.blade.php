...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Live Chat | Integration | Qchat | Qwords Chatting Platform</title>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-success waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#add-channel">
