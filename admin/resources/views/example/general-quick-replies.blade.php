...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Broadcast message | Operational | Qchat | Qwords Chatting Platform</title>
    ...
    <body data-sidebar="dark">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-success waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#new-message">
                                            <i class="ri-add-line align-middle mr-2"></i> New message
                                        </button>
                                    </div>
                                </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="new-message" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Select from the following message type</p>
                        <div class="form-group row">
                            <div class="col-md-3">
                                <button type="button" class="btn btn-light btn-block waves-effect waves-light">
                                    <i class="ri-whatsapp-line font-weight-bold text-success align-middle mr-2"></i> WhatsApp SME
                                </button>
                            </div>
                            <div class="col-md-3">
                                <button type="button" class="btn btn-light btn-block waves-effect waves-light">
                                    <i class="ri-whatsapp-line font-weight-bold text-success align-middle mr-2"></i> WhatsApp BA
                                </button>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control">
                                <option>Nanjak ID</option>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light waves-effect" data-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-primary waves-effect waves-light">Continue</button>
                    </div>
                </div>
            </div>
        </div>
