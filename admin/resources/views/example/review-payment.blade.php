...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Review payment | Qchat | Qwords Chatting Platform</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Review payment</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="media mb-4">
                                                    <img class="avatar-sm mr-3 rounded-circle" src="assets/images/illustration/img_wa.svg" alt="">
                                                    <div class="media-body">
                                                        <h5 class="mt-0 font-size-14">WhatsApp for SME - Silver</h5>
                                                        <h5><span class="text-success">Rp 500.000</span>/month</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-right">
                                                <div class="custom-control custom-switch mb-2" dir="ltr">
                                                    ...
                                                    <label class="custom-control-label" for="customSwitch1">Annual Payment</label>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="media mb-4">
                                                    <img class="avatar-sm mr-3 rounded-circle" src="assets/images/illustration/img_payment.svg" alt="">
                                                    <div class="media-body">
                                                        <h5 class="mt-0 font-size-14">Manual Payments</h5>
                                                        Make payments manually via bank transfers.
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 text-right">
                                                <button type="button" class="btn btn-outline-primary waves-effect waves-light">Change method</button>
                                            </div>
                                            <div class="col-md-8 mt-2 mb-3">
                                                <h6 class="mt-2">Total Amount Due</h6>
                                            </div>
                                            <div class="col-md-4 text-right mt-2 mb-3">
                                                <h5 class="font-weight-bold text-success mt-2">Rp 500.000</h5>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="alert alert-info alert-dismissible fade show mb-0" role="alert">
                                                    <i class="ri-information-line mr-2"></i>
                                                    Please allow up to 24 hours for our team to setup your channel after your payment has been verified. You will need to complete the payment before it reaches the due date once the invoice is generated.
                                                </div>
                                            </div>
                                            <div class="col-md-12 text-right">
                                                <a href="detail-invoice.html" class="btn btn-primary waves-effect waves-light mt-3">Continue & make payment</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
