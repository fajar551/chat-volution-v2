...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Invoice | Qchat | Qwords Chatting Platform</title>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="list-invoice.html"><span class="ri-arrow-left-line"></span> Back to unpaid invoices</a></li>
                                        </ol>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">TTT/NT/PF-INV/2021/VII/071</h4>
                                        <div class="row">
                                            <div class="col-md-2">
                                            ...
                                            <div class="col-md-12">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="col_description">
                                                                <b>WhatsApp for SME - Silver (monthly) - Listu</b>
                                                                <br>New channel subscription</td>
                                                            <td class="col_quantity">1</td>
                                                            <td class="col_price">Rp 500.000</td>
                                                            <td class="col_discount">-</td>
                                                            <td class="col_amount">Rp 500.000</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3"></td>
                                                            <td class="col_label"><b>Subtotal</b></td>
                                                            <td class="col_amount">Rp 500.000</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3"></td>
                                                            <td class="col_label"><b>Discount Amount</b></td>
                                                            <td class="col_amount">-</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3"></td>
                                                            <td class="col_label"><b>Tax Amount</b></td>
                                                            <td class="col_amount">-</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="3"></td>
                                                            <td class="col_label"><b>Total</b></td>
                                                            <td class="col_amount"><b>Rp 500.000</b></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">Please Transfer to The Following Account</h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5 class="pb-2">QChat Teknologi Bersatu</h5>
                                                <div class="alert alert-secondary alert-dismissible fade show" role="alert">
                                                    <img class="avatar-sm mr-2" src="assets/images/illustration/img_mandiri.svg"> 1020007706705
                                                    <button type="button" class="close mt-2" aria-label="Close">
                                                        <span aria-hidden="true"><span class="ri-file-copy-line ml-2"></span></span>
                                                    </button>
                                                </div>
                                                <div class="alert alert-info alert-dismissible fade show" role="alert">
                                                    <i class="mdi mdi-alert-circle-outline mr-1"></i>
                                                    Once you have completed payment please send payment proof to sales@taptalk.io to confirm. Please allow up to 24 hours for you payment to be verified
                                                </div>
                                            </div>
                                        </div>
                                    </div>
