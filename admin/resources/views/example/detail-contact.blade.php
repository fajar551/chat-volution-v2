...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Detail contact | Qchat | Qwords Chatting Platform</title>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-success waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#edit-contact">
                                            <i class="ri-pencil-line align-middle mr-2"></i> Edit
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-sm-12">
                                <div class="card pricing-box">
                                    <div class="card-header justify-content-between">
                                        <h5><span class="ri-user-line"></span> John Rosina</h5>
                                    </div>
                                    <div class="card-body p-4">
                                        <div class="form-group">
                                            <label><span class="ri-user-line"></span> Alias</label>
                                            <p>John</p>
                                        </div>
                                        <div class="form-group">
                                            <label><span class="ri-mail-line"></span> Email Address</label>
                                            <p>johnrosina@gmail.com</p>
                                        </div>
                                        <div class="form-group">
                                            <label><span class="ri-phone-line"></span> Phone Number</label>
                                            <p>+628732120011</p>
                                        </div>
                                        <div class="form-group">
                                            <label><span class="ri-calendar-line"></span> Date Created</label>
                                            <p>3 Sep 2021</p>
                                        </div>
                                        <div class="form-group">
                                            <label><span class="ri-earth-line"></span> Origin</label>
                                            <p>User Added</p>
                                        </div>
                                    </div>
                                </div>
