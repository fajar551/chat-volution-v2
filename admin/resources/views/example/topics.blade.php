...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Topics | Organization | Qwords Chatting Platform</title>
    ...
    <body data-sidebar="dark">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-success waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#add-topic">
                                            <i class="ri-add-line align-middle mr-2"></i> Add topic
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>1</td>
                                                    <td>
                                                        <a href="detail-topic.html" class="text-info mr-4"><i class="ri-information-line font-size-18" style="position: relative;top: 4px;"></i> Detail</a>
                                                        <a href="#detail-member" data-toggle="modal" class="text-danger"><i class="ri-delete-bin-7-line font-size-18" style="position: relative;top: 4px;"></i> Delete</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <!-- Modal -->
        <div class="modal fade" id="add-topic" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Add topic</h5>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="topicname" placeholder="Name of your topic">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light waves-effect" data-dismiss="modal">Cancel</button>
                        <button type="button" class="btn btn-primary waves-effect waves-light">Add topic</button>
                    </div>
                </div>
            </div>
        </div>
