...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Twitter DM | Integration | Qchat | Qwords Chatting Platform</title>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body text-center">
                                        <img class="p-2" src="assets/images/illustration/ic_twitter.svg">
                                        <p>Please contact our team to help you to integrate Twitter</p>
                                        <a href="" class="btn btn-primary">Email sales@qchat.com</a>
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end row -->
