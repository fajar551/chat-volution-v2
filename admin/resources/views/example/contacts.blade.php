...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Contacts | Operational | Qchat | Qwords Chatting Platform</title>
    ...
    <body data-sidebar="dark">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Contacts (0)</h4>
                                    <div class="page-title-right">
                                        <button type="button" class="btn btn-outline-info waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#download-all">
                                            <i class="ri-download-2-line align-middle mr-2"></i> Download all
                                        </button>
                                        <button type="button" class="btn btn-success waves-effect waves-light font-weight-bold" data-toggle="modal" data-target="#add-contact">
                                            <i class="ri-add-line align-middle mr-2"></i> Add contact
                                        </button>
                                    </div>
                                </div>
                                <p>Broadcast Message allows you to send a message to a single or multiple recipient at a single given time.</p>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#detail-live-chat" data-toggle="modal" class="text-info"><i class="ri-information-line font-size-18" style="position: relative;top: 4px;"></i> Detail</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>nanjak-ios</td>
        ...
        <!-- Modal -->
        <div class="modal fade" id="add-contact" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
