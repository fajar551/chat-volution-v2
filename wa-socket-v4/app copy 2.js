...
// Database routes
// wa1Router.get('/database/messages', async (req, res) => {
//   try {
...
// Client chat routes
wa1Router.get('/client-chat/health', (req, res) => {
  res.json({
    success: true,
...
// wa1Router.post('/client-chat/send', async (req, res) => {
//   try {
//     const { phone, message, agentId } = req.body;
//     if (!phone || !message) {
//       return res.status(400).json({
...
wa1Router.get('/client-chat/messages', (req, res) => {
  try {
    const messages = global.allMessages || [];
    res.json({
      success: true,
...
// ALSO handle requests without /wa1 prefix (for Apache ProxyPass)
// Apache sends /wa1/send to http://localhost:4003/send
app.use('/', wa1Router);
...
// REMOVED: Duplicate /send route - using /wa1/send instead
...
// REMOVED: Duplicate /messages routes - using /wa1/messages instead
...
// REMOVED: Duplicate /react-chat/messages routes - using /wa1/react-chat/messages instead

// REMOVED: Duplicate /react-chat/send route - using /wa1/react-chat/send instead
...
// REMOVED: Duplicate /client-chat/send route - using /wa1/client-chat/send instead

// REMOVED: Duplicate /client-chat/messages route - using /wa1/client-chat/messages instead
